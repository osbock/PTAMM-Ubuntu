...
CC = g++-7
COMPILEFLAGS = -I MY_CUSTOM_INCLUDE_PATH -D_LINUX -D_REENTRANT -Wall  -O3 -march=nocona -msse3 -fno-strict-aliasing -I/usr/include/ -I/usr/include/lib3ds
#LINKFLAGS = -L MY_CUSTOM_LINK_PATH -lGVars3 -lcvd $(3DSLIB)
LINKFLAGS = -L MY_CUSTOM_LINK_PATH -lGVars3 -lcvd $(3DSLIB) -L/usr/local/lib -lopencv_legacy -lopencv_core -lopencv_video -lopencv_highgui -lpthread -lGL -lGLU -lglut -lblas -llapack 
